...
class AnalyticsService {
  ...
  static async updateAnalytics(userId, period = '30days') {
    try {
      ...
      let analytics = await Analytics.findOrCreateForUser(userId, period);
  ...
  static async getAnalytics(userId, period = '30days') {
    try {
      ...
      // If no analytics found or data is old (more than 1 hour), update it
      if (!analytics || (new Date() - analytics.lastUpdated) > 3600000) {
