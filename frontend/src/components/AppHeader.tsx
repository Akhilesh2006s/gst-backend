import { Search, Bell, HelpCircle, Settings, User, Plus } from "lucide-react";
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="4.5" y="4" width="7" height="0.8" fill="#3B82F6"/>
                <rect x="4.5" y="5.5" width="5" height="0.8" fill="#3B82F6"/>
                <rect x="4.5" y="7" width="6" height="0.8" fill="#3B82F6"/>
                <rect x="4.5" y="8.5" width="4" height="0.8" fill="#3B82F6"/>
                <rect x="4.5" y="11" width="7" height="1" fill="#3B82F6"/>
                <text x="10" y="15" font-family="Arial" font-size="6" font-weight="bold" text-anchor="middle" fill="#3B82F6">₹</text>
              </svg>
            </div>
